...
public class InputManager
{
	...
	public List<IInputListener> inputListeners = new ArrayList<IInputListener>();
	...
	protected InputManager(Component component)
	{
		...
		component.addMouseListener(new MouseListener()
		{
			...
			public void mouseReleased(MouseEvent mouseEvent)
			{
				...
				{
					inputListener.mouseUp(mouseX, mouseY, mouseButton);
				}
			...
			public void mousePressed(MouseEvent mouseEvent)
			{
				...
				for (IInputListener inputListener : inputListeners)
				{
					inputListener.mouseDown(mouseX, mouseY, mouseButton);
				}
				updateCursor();
			}
		...
		component.addMouseWheelListener(new MouseWheelListener()
		{
			...
			public void mouseWheelMoved(MouseWheelEvent mouseWheelEvent)
			{
				for (IInputListener inputListener : inputListeners)
				{
					inputListener.mouseWheel(mouseWheelEvent.getWheelRotation());
				}
			}
		});
		...
		component.addMouseMotionListener(new MouseMotionListener()
		{
			...
			public void mouseMoved(MouseEvent mouseEvent)
			{
				...
				for (IInputListener inputListener : inputListeners)
				{
					inputListener.mouseMove(mouseX, mouseY, mouseButton);
				}
			}
	...
	/**
	 * Moves the mouse pointer to the center of the component.
	 */
